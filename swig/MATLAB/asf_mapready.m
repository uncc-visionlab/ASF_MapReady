...
jarDirectory = '/media/arwillis/Passport/SAR/ASF/ASF_MapReady/MATLAB';
...
%inBaseName = '/media/arwillis/Passport/SAR/data/ASF/E1_04693_STD_L0_F284/E1_04693_STD_L0_F284.000';
%inBaseName = '/media/arwillis/My Passport/SAR/data/ASF/J1_12380_STD_L0_F361/J1_12380_STD_L0_F361.000';
inBaseName = '/media/arwillis/Passport/SAR/data/ASF/J1_35580_STD_L0_F373/J1_35580_STD_L0_F373.000'
...
[cdata,nrow,ncol] = read_rawsar(rawCEOSFilename, I_bias, Q_bias,5000,5000);
cdata = fliplr(cdata);
%
...
epdfVals = ampHist/numel(amplitude);
%plot(binCenters,epdfVals);
%hold on;
ecdfVals=cumsum(epdfVals);
